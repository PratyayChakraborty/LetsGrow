    ...
    return (
        <Box className="container" color={"whatsapp.400"} fontSize="15px" padding="30px" margin="auto"
            ...
            <Box className="well">
                ...
                <h3 className="susp">PAYMENT BONUSES </h3>
                <h5 className="susp2" style={{ paddingTop: "20px" }}> Get <strong style={{ color: "red" }}>5% Bonus</strong> On All Payments By Adding Money Via Paytm </h5>
                <h5 className="susp2"> Get <strong style={{ color: "red" }}>6% Bonus</strong> On Adding More Than 10,000 Rs By Manual Payment </h5>
                <h5 className="susp2"> Get <strong style={{ color: "red" }}>7% Bonus</strong> On Adding More Than 20,000 Rs By Manual Payment </h5>
