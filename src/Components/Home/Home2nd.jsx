...
const Home2nd = () => {
    return (
        ...
        <Flex className="container" flexDirection={{ base: "column", md: "column", lg: "row" }} >
            ...
            <Box class="feature-content-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="50" color={"white"}>
                <h4 class="h5 text-primary">Empowering Social Media !</h4>
                ...
                <ul class="list-unstyled mt-5">
                    ...
                    <li class="d-flex align-items-start mb-4">
                        ...
                        <div class="icon-content">
                            <h3 class="h5">Unique &amp; Friendly Dashboard</h3>
                    ...
                    <li class="d-flex align-items-start mb-4">
                        <div class="icon-box bg-primary bg-purple rounded me-4">
                            <i class="fas fa-rocket text-white"></i>
                        </div>
                        <div class="icon-content">
                            <h3 class="h5">Super Fast Delivery</h3>
